...
- при неверных учетных данных `POST /api/auth/login` возвращает `401 Unauthorized`;
...
- `401 Unauthorized` — отсутствует/невалидный токен или неверные логин/пароль при входе
