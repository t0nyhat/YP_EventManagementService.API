...
- `Admin` управляет событиями и может просматривать или отменять любые бронирования.
- `User` создаёт бронирования и может просматривать или отменять только свои бронирования.
